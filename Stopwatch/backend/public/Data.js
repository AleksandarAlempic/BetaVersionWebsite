...
let classicSongs = [
   ...
   {
      name: 'Spring',
      path: '../../../../audio/Vivaldi Four Seasons_ Spring (La Primavera).mp3',
   ...
   },
   {
      ...
      path: '../../../../audio/Johannes Brahms -- Hungarian Dance No.5.mp3',
   ...
   },
   {
      ...
      path: '../../../../audio/The Lord Of The Rings - The Riders of Rohan.mp3',
   ...
   {
      name: 'The Power Of Love',
      path: '../../../../audio/IL DIVO - The Power Of Love (La Fuerza Mayor).mp3',
      artist: 'IL DIVO',
      cover: '../../../../images/audio/IlDivo.jpg'
   },
   {
...
let narodnjaciSongs = [
  ...
  {
    name: 'Kazni me',
    path: '../../../../audio/Vesna Zmijanac - Kazni me.mp3',
    artist: 'Vesna Zmijanac',
  ...
  {
    name: 'Jutro je',
    path: '../../../../audio/Nada Topcagic - Jutro je.mp3',
  ...
  },
  {
    ...
    path: '../../../../audio/Ana Bekuta - Imam jedan zivot.mp3',
    artist: 'Ana Bekuta',
    cover: '../../../../images/audio/AnaBekuta.jpg'
  },
  {
    name: 'Molitva',
    path: '../../../../audio/MARIJA SERIFOVIC - MOLITVA.mp3',
  ...
  {
    name: 'Legitimno',
    path: '../../../../audio/ALEKSANDRA PRIJOVIC - LEGITIMNO.mp3',
    artist: 'Aleksandra Prijović',
    cover: '../../../../images/audio/Legitimno.jpg'
  },
  {
    name: 'Placebo',
    path: '../../../../audio/ALEKSANDRA PRIJOVIC - PLACEBO.mp3',
    artist: 'Aleksandra Prijović',
    cover: '../../../../images/audio/Placebo.jpg'
  },
  {
    name: 'U inat prošlosti',
    path: '../../../../audio/Aleksandra Radovic - Who Gonna Stop Me Now.mp3',
...
let danceSongs = [
   ...
   {
      name: 'Aint Your Mama',
      path: '../../../../audio/Jennifer Lopez - Aint Your Mama.mp3',
      artist: 'Jennifer Lopez',
      cover: '../../../../images/audio/JenniferLopez.jpg'
   },
   {
      name: 'Cheap Thrills ft. Sean Paul',
      path: '../../../../audio/Sia - Cheap Thrills ft. Sean Paul.mp3',
      artist: 'Sia ft. Sean Paul',
      cover: '../../../../images/audio/CheapThrils.jpg'
   },
   {
      name: 'Say It Right',
      path: '../../../../audio/Nelly Furtado - Say It Right.mp3',
      artist: 'Nelly Furtado',
      cover: '../../../../images/audio/NellyFurtado.jpg'
   },
   {
      name: 'Walk',
      path: '../../../../audio/Kwabs - Walk.mp3',
      artist: 'Kwabs',
      cover: '../../../../images/audio/Kwabs.jpg'
   },
   {
      name: 'La Vida Tombola',
      path: '../../../../audio/Manu Chao - La Vida Tombola.mp3',
      artist: 'Manu Chao',
      cover: '../../../../images/audio/LaTombola.jpg'
   },
   {
      name: 'Brother Louie 98',
      path: '../../../../audio/Modern Talking - Brother Louie 98.mp3',
      artist: 'Modern Talking',
      cover: '../../../../images/audio/BrotherLouie.jpg'
   },
   {
      name: 'Amor, Amor',
      path: '../../../../audio/Jennifer Lopez - Amor, Amor, Amor.mp3',
      artist: 'J.Lopez ft. Wisin',
      cover: '../../../../images/audio/JeniferLopezAmor.jpg'
   },
   {
      name: 'Vivir Mi Vida',
      path: '../../../../audio/Marc Anthony - Vivir Mi Vida.mp3',
      artist: 'Marc Anthony',
      cover: '../../../../images/audio/MarchAnthony.jpg'
   },
   {
      name: 'We Are One',
      path: '../../../../audio/We Are One (Ole Ola) [Official 2014 FIFA World Cup Song].mp3',
...
let rockSongs = [
   ...
   },
   {
      ...
      path: '../../../../audio/Modern Talking - Cheri Cheri Lady.mp3',
      artist: 'Modern Talking',
      cover: '../../../../images/audio/CherryCherry.jpg'
   },
   {
      name: 'Gimme! Gimme!',
      path: '../../../../audio/ABBA - Gimme! Gimme! Gimme!.mp3',
      artist: 'ABBA',
      cover: '../../../../images/audio/ABBA-GimmeGimmeGimme-video.png'
   },
   {
...
let classicArabSongs = [
   {
      ...
      cover: '../../../../images/audio/MaiFarouk.jpg'
   },
   {
      name: 'Ahwak',
   ...
   },
   {
      ...
      path: '../../../../audio/National Arab Orchestra - Alf Leila wi Leila.mp3',
      artist: 'National Arab Orchestra',
      cover: '../../../../images/audio/AlfLeilaWiLeila.jpg'
   },
   {
      name: 'Ana Fi Intizarak',
      path: '../../../../audio/National Arab Orchestra - Ana Fi Intizarak.mp3',
      artist: 'National Arab Orchestra',
      cover: '../../../../images/audio/AnaFiIntizarak.jpg'
   },
   {
      name: 'El Bent El Shalabeya',
      path: '../../../../audio/National Arab Orchestra - El Bent El Shalabeya.mp3',
      artist: 'National Arab Orchestra',
      cover: '../../../../images/audio/ElBentElShalabeya.jpg'
   }
];
